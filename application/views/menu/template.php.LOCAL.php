...
$template = array(
    ...
    'description' => 'Sistema d epunto de ventas',
...
$primary_nav = array(
    ...
    array(
        'name' => 'Estadistica de utilidades',
        'url' => $ruta . 'opciones',
        'icon' => 'fa fa-caret-square-o-up',
    ...
    array(
        'name' => 'Utilidades por cliente',
        'url' => $ruta . 'opciones',
        'icon' => 'fa fa-caret-square-o-up',
        'slug' => 'utilidadescliente'
    ),
    array(
        'name' => 'Utilidades por proveedor',
        'url' => $ruta . 'opciones',
        'icon' => 'fa fa-caret-square-o-up',
                ...
                <?php if ($template['header_content'] == 'horizontal-menu') { // Horizontal Menu Header Content ?>
                    ...
                    <div id="horizontal-menu-collapse" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            <li>
                                <a href="<?= $ruta ?>producto">Stock Producto</a>
                            </li>
                            <li>
