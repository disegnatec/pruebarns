<?php
function very_key($reqHeader, $get, $post, $options)
{
    ...
    } else if (isset($options['X-api-key'])) {
        $key = $options['X-api-key'];
    } else if (isset($get['x-api-key'])) {
        $key = $get['x-api-key'];
    } else if (isset($post['x-api-key'])) {
        $key = $post['x-api-key'];
    } else {
        $key = null;
    }
